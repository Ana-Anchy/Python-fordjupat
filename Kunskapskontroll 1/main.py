...
def parse_args():
    ...
    p.add_argument("--limit", type=int, default=50, help="antal annonser per sida (stabilt: 50)")
    p.add_argument("--pages", type=int, default=10, help="antal sidor att hämta (t.ex. 10 => ~500 oglasa)")
    p.add_argument("--log-level", default="INFO", help="DEBUG/INFO/WARNING/ERROR")
    p.add_argument("--db", default="af_ads.db", help="sökväg till SQLite-databasen")
    return p.parse_args()
